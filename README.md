...
For questions and general discussion, use [GitHub Discussions](https://github.com/GRobalinoU/ed-cse/discussions).

For bugs and feature requests, use [GitHub Issues](https://github.com/GRobalinoU/ed-cse/issues).
